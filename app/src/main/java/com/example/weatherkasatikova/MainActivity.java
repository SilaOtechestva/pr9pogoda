package com.example.weatherkasatikova;
            ...
            private void setImage(final ImageView view_weather, final String value) {
                switch (value) {
                    ...
                    case "11n": view_weather.setImageDrawable(getResources().getDrawable(R.drawable.icon7));
                        break;
                 //   case "13d": view_weather.setImageDrawable(getResources().getDrawable(R.drawable.icon8));
                 //       break;
                 //   case "13n": view_weather.setImageDrawable(getResources().getDrawable(R.drawable.icon8));
                 //       break;
                    default:
